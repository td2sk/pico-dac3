...
pub fn write_uac2<B: UsbBus>(
    ...
    // Sampling frequency is RW; clock validity is read-only.
    writer.write(CS_INTERFACE, &[0x0a, 0x04, 0x03, 0x07, 0x01, 0x00])?;
    writer.write(
        CS_INTERFACE,
        &[
    ...
    writer.write(
        CS_INTERFACE,
        &[0x03, 0x03, 0x04, 0x03, 0x01, 0x02, 0x04, 0x00, 0x00, 0x00],
    )?;
    writer.write(
        CS_INTERFACE,
        &[
    ...
    for (alt, subslot, resolution) in [(1, 2, 16), (2, 4, 24), (3, 4, 32)] {
        ...
        writer.write(
            CS_INTERFACE,
            &[
                0x01, 0x01, 0x00, 0x01, 0x01, 0x00, 0x00, 0x00, 0x02, 0x03, 0x00, 0x00, 0x00, 0x00,
            ],
        )?;
